 ...
 */
function useAuthenticatedAccountCustomer() {
  const account = useApi().authenticatedAccount;
 ...
 */
function useAuthenticatedAccountPurchasingCompany() {
  const account = useApi().authenticatedAccount;
  return useSubscription(account.purchasingCompany);
}

export { useAuthenticatedAccountCustomer, useAuthenticatedAccountPurchasingCompany };
