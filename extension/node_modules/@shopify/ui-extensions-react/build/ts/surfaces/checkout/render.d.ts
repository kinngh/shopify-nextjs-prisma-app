...
import type { ExtensionTargets, RenderExtensionTarget, ApiForExtension } from '@shopify/ui-extensions/checkout';
/**
 ...
 * own backend.
 */
export declare function reactExtension<Target extends RenderExtensionTarget>(target: Target, render: (api: ApiForExtension<Target>) => ReactElement<any> | Promise<ReactElement<any>>): ExtensionTargets[Target];
/**
 * Registers your React-based UI Extension to run for the selected extension target.
 * Additionally, this function will automatically provide the extension API as React
 * context, which you can access anywhere in your extension by using the `useApi()`
 ...
 */
export declare function render<Target extends RenderExtensionTarget>(target: Target, render: (api: ApiForExtension<Target>) => ReactElement<any>): ExtensionTargets[Target];
